...
df = pd.read_csv('mix_namg_pro.csv')
#df = pd.read_csv('pore_na2so4.csv')
df.head()

# Putting feature variable to X
X = df.drop('namg',axis=1)
...
X_train_all.shape, X_test.shape
X_train, X_ver, y_train, y_ver = train_test_split(X_train_all, y_train_all, train_size=0.8, random_state=80)#nacl_45,na2so4_193,33,mgso4_169,mgcl2_45
X_train.shape, y_ver.shape
model = xgb.XGBRegressor(n_estimators=180, 
